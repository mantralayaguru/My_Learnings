...
IIQ.PEB = (function() {
	...
	return {
		...
		createIIQPEBElements: function () {
			...
			var peUrl = protocol + '//bid.intentiq.com/profiles_engine/ProfilesEngineServlet';
			...
			var iframeUrl = peUrl + '?at=15&aw=468&ah=60&pagePos=1&vip=true&secure=' + secure + '&eid=' + eid + random + pageUrl;
			...
			createCookie("IQBlock", "1", 10000, ".intentiq.com");
		}
	}
})();
